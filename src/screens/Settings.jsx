  ...
  return (
    <section className="panel">
        ...
        <div className="field">
          ...
          <div className="field-row">
            <input
              ...
              onChange={(event) => handleApiConfigChange({ apiKey: event.target.value })}
              placeholder="sk-..."
            />
            <button
              type="button"
          ...
          <small>Stored in local storage on this device.</small>
        </div>
        <div className="field">
      ...
      <div className="settings-section">
        ...
        <p className="helper">
          Claude receives the board as JSON along with prior clues and guesses plus the
        ...
        <form className="stack" onSubmit={handlePersonaSubmit}>
          ...
          <div className="field">
            ...
            <textarea
              ...
              placeholder="Describe how Claude should behave..."
            />
          </div>
          <div className="settings-actions">
            <button type="submit" className="primary">
